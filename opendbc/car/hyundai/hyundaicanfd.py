...
def create_steering_messages(packer, CP, CAN, enabled, lat_active, apply_torque, lkas_icon, hud_control=None):
  ...
  values = {
    "LKA_OptUsmSta": 2,
    "LKA_SysIndReq": 3 if (left_lane_depart or right_lane_depart) else lkas_icon,
